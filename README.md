...
## Sample code
Sample C code for the library is available in `src/bin`. Refer to the documentation in the `rust`. `python` and `wasm` binding directories for related sample code.
