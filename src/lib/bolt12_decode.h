...
#define BOLT12_DECODE_OBJECT_ERROR_BASE (0x200000000000000)
#define BOLT12_DECODE_GENERAL_ERROR_BASE (0x400000000000000)
#define BOLT12_DECODE_BECH32_ERROR_BASE  (0x800000000000000)

enum eBolt12DecodeErrors{
  BOLT12_OK = 0,
  BOLT12_MEMORY_ALLOC_ISSUE = -1,
